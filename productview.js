...
$(document).ready(function() {
  ...
  $.getJSON('/items/client_data.json', function(combined) {
    ...
    var item_template                = Hogan.compile(templates.item),
        ...
        spotlight_pass_template      = Hogan.compile(templates.spotlight_passementerie), // is this still in use anymore?
        dummy_template               = Hogan.compile(templates.bookends),
        dummy_template_pass          = Hogan.compile(templates.bookends_passementerie), // is this still in use anymore?
