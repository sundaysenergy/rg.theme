$(document).ready(function() {
  ...
  $.getJSON('http://rg.cape.io/items/price.json', function(item_prices) {
    ...
    $.getJSON('http://rg.cape.io/items/client_data.json', function(combined) {
      ...
      var itemPrice = function(token) {
        var price = false;
        $.ajax({
          url: 'http://rg.cape.io/restricted',
          type: 'GET',
          async: false,
      ...
      console.log(itemPrice($.cookie('token')));
